...
start_screen_animation_frame = 0
...
function _draw()
  ...
  if is_game_over_mode then
    ...
    return
  elseif is_start_screen_mode then
    render_start_screen()
    return
  end
...
function render_start_screen()
  ...
  local step =  start_screen_animation_frame

  function get_bounce(step, offset)
    step = flr(step/5) - offset
    if step % 6 == 1 then return 2 end
    if step % 6 < 3 then return 1 end
    return 0
  end

  function render_line(step)
    if stop then
      step = 128
    elseif step > 50 then
      step = 128
  ...
  spr(9, 20,     40 - get_bounce(step, 0), 2, 2)
  spr(11, 20+16, 40 - get_bounce(step, 2), 2, 2)
  spr(13, 20+32, 40 - get_bounce(step, 4), 2, 2)
  render_line(step)

  start_screen_animation_frame += 1

  message = "press any key to begin"
  coords = get_center_text_positions(message, 64)
  if stop then
    print(message, coords.x, 76, 7)
  end
end
...
__gfx__

...

__music__
00 04050644
